...
$(document).ready(function() {
	...
	$('#form-usuario').validate({
		...
		messages : {
			"usuario.nome" : {required : "Campo localidade não pode ser vazio"},
			"usuario.login" : {required : "Campo login não deve ser vazio"},
			"usuario.email" : {required : "Campo email não deve ser vazio", email : "Esse email não é válido"}
		},
