...
$(document).ready(function() {
	...
	$('#form-localidade').validate({
		rules : {
			"localidade.nome" : {required : true}
		}, 
		messages : {
			"localidade.nome" : {required : "Campo localidade não pode ser vazio"}
		},
...
<div class="bg-corpo">
    ...
    <div class="corpo">
        ...
        <div class="conteudo centraliza">
            ...
            <h1 class="titulo"><img src="../layout/img/ico-cadastro.png" alt="Bem vindo ao hpvc" width="41" height="51" />Cadastrar Localidade</h1>
            ...
            <!-- INICIO FORMULARIO -->
            <form action="<c:url value="/localidade/realizar-cadastro" />" method="post" id="form-localidade" class="form-hpvc" style="margin:0 0 0 125px;">
              ...
              <label for="Nome">Nome:
              	<input type="text" name="localidade.nome" id="nome" style="width: 450px;" />              	
              </label>
                      
              <input type="submit" class="botao fright" value="Cadastrar Localidade" />
            </form>
            <!-- FIM FORMULARIO -->
            
            <!-- INICIO DA TABELA -->
            <c:if test="${localidades != null}">
